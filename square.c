...
UINT8 dXlut[32] = {144,140,136,132,128,124,120,116,112,108,104,100,96,92,88,84,80,76,72,68,64,60,56,52,48,44,40,36,33,30,27,24};
UINT8 dYlut[32] = {16,43,59,70,79,86,92,98,102,106,110,114,117,120,122,125,127,129,132,134,135,137,139,141,142,144,145,147,148,149,151,152};
...
void main()
{
    ...
    while(!0)
	{
       ...
       /* if (joypad() == J_DOWN && tempo != 1 )
		...
		if ( padext == J_BUP)
		{
			if(currentSaveSlot < 3)
			{
				currentSaveSlot += 1;
			    set_sprite_tile(6, 12);
			    move_sprite(6, 160, savelut[currentSaveSlot]);
			}
			performantdelay(5);
		}
